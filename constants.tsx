...
export const SunIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v1m0 16v1m8.4-12.6l-.7.7m-11.4 11.4l-.7.7M21 12h-1M4 12H3m16.4-7.4l-.7.7m-11.4 11.4l-.7.7M12 8a4 4 0 100 8 4 4 0 000-8z" />
  </svg>
);
...
export const NAV_ITEMS = [
  ...
  { path: '/skills', label: 'Skills', icon: ChartIcon },
  { path: '/roadmaps', label: 'Roadmaps', icon: ClipboardListIcon },
